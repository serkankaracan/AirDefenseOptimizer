        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if (_munitionData == null)
                {
                    ...
                    _munitionService.AddMunition(txtMunitionName.Text, ((MunitionType)cbMunitionType.SelectedValue).ToString(),
                        double.Parse(txtWeight.Text), double.Parse(txtSpeed.Text), double.Parse(txtRange.Text),
                        double.Parse(txtExplosivePower.Text), double.Parse(txtCost.Text));
                }
                else
                {
                    // Var olan mühimmat güncelleme işlemi
                    _munitionService.UpdateMunition((int)_munitionData.Id, txtMunitionName.Text,
